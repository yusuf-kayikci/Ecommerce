    ...
    function nbuttonGroup(o, multiple) {
        ...
        function setSelectionDisplay() {
            ...
            $.each(o.lrs, function (index, item) {
                ...
                items += rbtn('awe-btn awe-il ' + selected, econ(item, o), 'data-index="' + index + '" data-val="' + encode(kp(item)) + '"');
            });
    ...
    function gridInlineEdit(createUrl, editUrl, oneRow, reloadOnSave, rowClick, dataFunc, initRow) {
        ...
        return function (o) {
            ...
            function inlineEdit($row, td) {
                ...
                var cx = { id: idf, model: model, val: getVal };
                        ...
                        if (inlelms && inlelms.length) {
                            ...
                            for (var j = 0; j < inlelms.length; j++) {
                                ...
                                if (column.Hid) {
                                    ...
                                    var validstr =
                                        prop &&
                                            inlHtml.indexOf("awe-gvalidmsg") === -1 ?
                                                rdiv('awe-gvalidmsg ' + prop, se, 'vld-for="' + prop + '"') :
                                                se;
    ...
    function gridColSel(o) {
        ...
        function getColumnsDataFunc() {
            ...
            $.each(o.columns, function (i, col) {
                var name = col.Tag && col.Tag.Caption || col.H || col.P || "col" + (i + 1);
